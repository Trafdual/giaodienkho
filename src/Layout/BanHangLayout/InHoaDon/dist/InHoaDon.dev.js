...
var handleGeneratePDF = function handleGeneratePDF(hoadondata) {
  ...
  var noidung = 'Thanh toan hoa don';
  ...
  }).join(''), "\n        </tbody>\n      </table>\n      <img src=\"https://img.vietqr.io/image/MB-2220198032222-compact2.png?amount=").concat(hoadondata.tongtien, "&addInfo=").concat(noidung, "&accountName=NGUYEN NGOC CHIEN\" alt=\"logo\" style=\"width: 200px; margin-top: 20px;\"/>\n    </div>\n  "); // Chuyển HTML sang PDF
