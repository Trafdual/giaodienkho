...
import { AddMucThuChi } from './AddMucThuChi'
import { EditMucThuChi } from './EditMucThuChi'


function MucThuChiLayout () {
  ...
  const fetchData = async (page = 1) => {
    try {
      const response = await fetch(
        `${getApiUrl('domain')}/getmucthuchiadmin/${
        ...
        <div className='divnhanvien'>
          <div className='detailsnhap'>
            <div className='recentOrdersnhap'>
              ...
              >
                <h4>{selectedItems.length} mục thu chi được chọn</h4>
                ...
                <table className='tablenhap'>
                  <thead className='theadnhap'>
                    <tr>
                      ...
                      <td className='tdnhap'>Tên mục thu chi</td>
                      <td className='tdnhap'>Loại mục</td>
                    </tr>
                  </thead>
            ...
            <ModalDelete2
              ...
              fetchdata={fetchData}
              link={`${getApiUrl('domain')}/deletemucthuchi`}
              content={'Bạn có chắc chắn xóa những mục thu chi này'}
...
export default MucThuChiLayout
